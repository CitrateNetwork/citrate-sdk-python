...
# Active audit reference — `citrate-sdk-python`
...
- This repo's folder: `.../per-repo/citrate-sdk-python/` — `MAP.md` (architecture + data-flow +
...
- Phase-1 mapping complete; see `per-repo/citrate-sdk-python/MAP.md` for the mapped surface and
